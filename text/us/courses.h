COURSE_ACTS(COURSE_BOB, _(" 1 SUNSHINE SECRET"),
       _("STARRY NIGHT CARNIVAL")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 MUSHROOM KINGDOM SKIES"),
       _("ITS RAINBOW ROAD")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
